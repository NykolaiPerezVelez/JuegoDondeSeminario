...
def mostrarPantallaGameOver(p):
        ...
        background_image = load_image('gameover.jpg')
...
if __name__ == '__main__':
    pygame.init()
    GuardarUsuarioGameOver(instanciaUsuario (usuarioJugando, puntajeFinalJuego))
...
def PonerMusicaRandom():
    ...
    a.append("eyes.mp3")
    pygame.mixer.music.load(a[random.randrange(10)])
    pygame.mixer.music.play(-1)
...
#######################################################################
def GuardousuarioEnTXT (usuarioJugando, puntajeFinalJuego):
    if (puntajeFinalJuego>= usuarioJugando[3]):
        usuarioGameOver = (int(usuarioJugando[0]),str(usuarioJugando[1]),
            int(usuarioJugando[2]),int(puntajeFinalJuego))
    else:
        usuarioGameOver = (int (usuarioJugando[0]),str(usuarioJugando[1]),
            int (usuarioJugando[2]),int (usuarioJugando[3]))
    a = usuarioGameOver[0]
    b = usuarioGameOver[1]
    c = usuarioGameOver[2]
    d = usuarioGameOver[3]
    archi=open('usuarios.txt','a')
    archi.write(str(a) +"," +b +"," +str(c) + "," +str(d)+"\n")
    archi.close()
########################################################################